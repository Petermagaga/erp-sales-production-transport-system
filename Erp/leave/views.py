...
from .serializers import LeaveBalanceSerializer,LeaveTypeSerializer,LeaveRequestSerializer
from accounts.permissions import BaseModulePermission,IsownerOrAdmin,ApprovalWorkflowPermission


class LeaveRequestViewSet(viewsets.ModelViewSet):
    serializer_class=LeaveRequestSerializer
    permission_classes=[BaseModulePermission,IsownerOrAdmin,ApprovalWorkflowPermission]
