...
import { createProduction } from "../../api/productionApi";
...
const AddProduction = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createProduction(unifiedRaw, unifiedFlour);
      toast.success("✅ Production records saved successfully!");
      setTimeout(() => navigate("/production"), 2000);
    } catch (error) {
